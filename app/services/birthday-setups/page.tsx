...
export default function BirthdaySetupsPage() {
  return (
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-2xl leading-8 text-gray-300">
              Celebrate every birthday with creative themes, beautiful decorations,
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        >
          <h2 className="mb-8 text-4xl font-bold">
            Celebrate with <span className="text-[#D4AF37]">SK Events</span>
          </h2>

          <p className="text-lg leading-8 text-gray-400">
            From kids' birthdays to elegant adult celebrations, we create
            customized decorations, themed setups, balloon arrangements, and
            stunning party experiences that make every celebration unforgettable.
          </p>
        </motion.div>
      </section>
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-400">
                  Beautifully designed to create unforgettable birthday memories.
                </p>
              </motion.div>
            ))}
          </div>
      ...
      <section className="bg-[#121212] px-6 py-24">
        ...
        >
          ...
          <p className="mt-6 leading-8 text-gray-400">
            Contact SK Events today and let us create a birthday celebration
